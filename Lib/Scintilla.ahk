...
{
Global SCI_SETSELECTION:=2572,SCI_ADDSELECTION:=2573,SCI_COUNTCHARACTERS:=2633,SCI_CLEARTABSTOPS:=2675,SCI_ADDTABSTOP:=2676,SCI_GETNEXTTABSTOP:=2677,SCI_COLOURISE:=4003
}
}
